<template>
  <div id="login">
    <div class="wrap">
      ...
      <div class="form">
        <div>
          <InputGroup v-model="phoneData.value" :inputData="phoneData" @btnClick="sendCode"></InputGroup>
        </div>
        <div>
...
export default class Login extends Vue {
  ...
  sendCode() {
    ...
    _this.$server.getVerifyCode(_this).then((res: any) => {
      ...
      _this.$server
        ...
        .then((res: any) => {
          ...
          if (data.code == 0) {
            ...
            localStorage.setItem("login_user", _this.phoneData.value);
            _this.$router.push("/");
          } else if (data.code == -1) {
            _this.$message({
              message: data.msg,
