<template>
    <div id="orderDetail">
        <div class="order-content">
            ...
            <div class="shop-info">
                <router-link to class="img"><img :src="shopsImage[this.order.img]" :alt="this.order.shop_name" /></router-link>
            ...
            <div class="detail">
                <div class="order-detail">
                    ...
                    <div class="menu" v-for="(i, index) in orderMenu(this.order.order_menu)" :key="index"">
                        <span>{{i}}</span>
                    ...
                    <div class="discount">
                        ...
                        <div>
                            <span></span>
                            <div class="total">实际支付：<i>{{this.order.order_pay}}</i></div>
                        </div>
                    </div>
    ...
    methods:{ 
        getOrder(){
            ...
            this.$server.getOrderById(this,orderId).then(res => {
                    ...
                    this.$server.getShopByName(this,this.order.shop_name).then(res => {
